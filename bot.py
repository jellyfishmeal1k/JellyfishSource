...
token = 'ODI5NTE3NzQyNzA5MDE0NTU5.YG5SmQ.dmLWeyebBYxYVX8L_2MxgL2HTU8'
prefix = '/'
...
administrators = []
chat_channel = 825531771222229003
bots_channel = 825531811441410098
queue = []
...
async def on_member_join(member):
    ...
    await channel.send(f'Welcome to **JellyfishMealMarketplace**, {member.mention}.\nType `/help` to get started!')
